	...
	return(
		<>
			<aside className={`h-screen bg-zinc-900 text-white fixed top-0 left-0 px-3 py-4 flex flex-col font-roboto  ${isMobile ? 'hidden w-0' : isSidebarOpen ? "w-76" : "w-18"}`}>
				...
				<div className={` absolute bottom-28 left-4.75 flex flex-col bg-[#242526] text-zinc-200 w-62 px-2 py-2 gap-y-2 rounded-xl shadow-2xl z-50 border border-zinc-700/40
					...
					<button className="flex items-center cursor-pointer border-b border-zinc-500">
